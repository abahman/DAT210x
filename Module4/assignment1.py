...
plyfile = PlyData.read('/Users/ammarbahman/desktop/dat210x/Module4/Datasets/stanford_armadillo.ply')
...
def do_PCA(armadillo):
  ...
  #
    ...
    print armadillo.shape # the orignal number of componet of armadillo (i.e 3)
    print T.shape #to see the number of transformed component (now it is 2)
    return T
...
def do_RandomizedPCA(armadillo):
  ...
  #
    ...
    rand_pca.fit(armadillo)
    rand_T = rand_pca.transform(armadillo)
    print armadillo.shape # the orignal number of componet of armadillo (i.e 3)
    print rand_T.shape #to see the number of transformed component (now it is 2)
