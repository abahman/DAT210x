...
def drawPlots(model, wintitle='Figure 1'):
  ...
  print y_train
  colors = [y_colors[i] for i in y_train['wheat_type']]
...
#
X = pd.read_csv('/Users/ammarbahman/desktop/dat210x/Module6/Datasets/wheat.data', sep = ',')
#print X
#print X.dtypes
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=7) # X are the data, and y is the labels
...
svc = SVC(kernel='linear', C = C) #where C is laready defined in the beginning of the code
