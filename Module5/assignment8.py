...
#
df = pd.read_csv('/Users/ammarbahman/desktop/dat210x/module5/Datasets/life_expectancy.csv', sep = '\t')
#print df.describe()
#print df.dtypes
...
#
train = df[df['Year']<1986]
X_train = train[['Year']]
y_train = train[['WhiteMale']] #read below very important
...
# loaded dataset
#
print df['WhiteMale'][df['Year']==2014]
...
print df['BlackFemale'][df['Year']==2014]
...
#
correlation = df.corr()
print correlation #the correlation values and correlation figure can show which has the highest relationship with whom
