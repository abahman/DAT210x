...
# on it.
df = pd.read_csv("/Users/ammarbahman/desktop/dat210x/Module5/Datasets/Wholesale_customers_data.csv")
...
T = preprocessing.normalize(df) #gives the most accurate graph -- in my opinion
