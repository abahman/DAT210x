...
# called X:
#
X = pd.read_csv('/Users/ammarbahman/desktop/dat210x/module5/Datasets/College.csv', sep = ',', index_col = 0)
...
#
room = X[['Room.Board']] #y-value (output)
accept = X[['Accept']] #x-value (input)

from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(accept, room, test_size=0.3, random_state=7)
...
Enroll = X[['Enroll']]
accept = X[['Accept']]
X_train, X_test, y_train, y_test = train_test_split(accept, Enroll, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
accept = X[['Accept']]
X_train, X_test, y_train, y_test = train_test_split(accept, failed, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
#
R_E = X[['Room.Board','Enroll']] #x-value (input)
accept = X[['Accept']] #y-value (output)
X_train, X_test, y_train, y_test = train_test_split(R_E, accept, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
