...
def showandtell(title=None):
  if title != None: plt.savefig("/Users/ammarbahman/desktop/dat210x/Module5/"+title + ".png", bbox_inches='tight', dpi=300)
  plt.show()
  exit()
...
def doKMeans(data, clusters=0):
  #
  # TODO: Be sure to only feed in Lat and Lon coordinates to the KMeans algorithm, since none of the other
  ...
  #
    ...
    kmeans_model = KMeans(n_clusters=clusters) #K-mean value entered here (i.e cluster)
...
#showandtell(title='Cell_Towers') #comment if want to proceed
