...
#
X = pd.read_csv('/Users/ammarbahman/desktop/dat210x/Module5/Datasets/wheat.data',sep =',')
...
# of the assignment.
#
ordered_wheat_type = ['kama', 'rosa', 'canadian']
y = y.astype("category", ordered=True, categories=ordered_wheat_type).cat.codes

#
# TODO: Basic nan munging. Fill each row's nans with the mean of the feature
#
for feature in X:
    X[feature].fillna(X[feature].mean())
...
# boundary in 2D, would be if your KNN algorithm ran in 2D as well
#
