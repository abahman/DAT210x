...
zero = []
for i in range(50):
    rate, data = wavfile.read('/Users/ammarbahman/desktop/dat210x/module5/Datasets/0_jackson_'+str(i)+'.wav')
    zero.append(data)
...
# n_audio_samples
#
n_audio_samples = len(zero[0][:]) #since it is a square matrix, it doesn't matter which raw you pick, I took first row
...
sample_rate = rate
wavfile.write('/Users/ammarbahman/desktop/dat210x/module5/Datasets/Original_Test_Clip.wav', sample_rate, test)
...
#
NP = Provided_Portion * n_audio_samples
...
#
X_train = train[0][:int(NP)]
y_train = train[0][int(NP):]
...
wavfile.write('/Users/ammarbahman/desktop/dat210x/module5/Datasets/Extrapolated_Clip.wav', sample_rate, completed_clip[0])
